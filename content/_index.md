...
<a class="flex !rounded-md bg-primary-600 px-4 py-3 !text-neutral !no-underline hover:!bg-primary-500 dark:bg-primary-800 dark:hover:!bg-primary-700 items-center" href="https://t98.info/contact/" target="_blank">
<span class="mr-1">
<span class="relative block align-text-bottom icon">
